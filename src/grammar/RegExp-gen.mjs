...
function LeadSurrogate_CharacterValue([Hex4Digits], l, reject) {
  return Hex4Digits >= 0xD800 && Hex4Digits <= 0xDBFF ? Hex4Digits : reject;
}


function TrailSurrogate_CharacterValue([Hex4Digits], l, reject) {
  return Hex4Digits >= 0xDC00 && Hex4Digits <= 0xDFFF ? Hex4Digits : reject;
}


function NonSurrogate_CharacterValue([Hex4Digits], l, reject) {
  return Hex4Digits < 0xD800 || Hex4Digits > 0xDFFF ? Hex4Digits : reject;
}
...
function IdentityEscape_CharacterValue([ch]) {
...
let ParserRules = [
    ...
    {"name": "Quantifier", "symbols": ["QuantifierPrefix"], "postprocess": ([QuantifierPrefix]) => ({ type: 'Quantifier', QuantifierPrefix, greedy: true })},
    {"name": "Quantifier", "symbols": ["QuantifierPrefix", {"literal":"?"}], "postprocess": ([QuantifierPrefix]) => ({ type: 'Quantifier', QuantifierPrefix, greedy: false })},
    {"name": "QuantifierPrefix", "symbols": [{"literal":"*"}], "postprocess": QuantifierPrefix_nt},
    {"name": "QuantifierPrefix", "symbols": [{"literal":"+"}], "postprocess": QuantifierPrefix_nt},
    {"name": "QuantifierPrefix", "symbols": [{"literal":"?"}], "postprocess": QuantifierPrefix_nt},
    {"name": "QuantifierPrefix", "symbols": [{"literal":"{"}, "DecimalDigits", {"literal":"}"}], "postprocess": ([_, [DecimalDigits]]) => ({ type: 'QuantifierPrefix', subtype: 'fixed', DecimalDigits: Number(DecimalDigits) })},
    {"name": "QuantifierPrefix$string$1", "symbols": [{"literal":","}, {"literal":"}"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "QuantifierPrefix", "symbols": [{"literal":"{"}, "DecimalDigits", "QuantifierPrefix$string$1"], "postprocess": ([_, [DecimalDigits]]) => ({ type: 'QuantifierPrefix', subtype: 'start', DecimalDigits: Number(DecimalDigits) })},
    {"name": "QuantifierPrefix", "symbols": [{"literal":"{"}, "DecimalDigits", {"literal":","}, "DecimalDigits", {"literal":"}"}], "postprocess": ([_, [DecimalDigits1], c, [DecimalDigits2]]) => ({ type: 'QuantifierPrefix', subtype: 'range', DecimalDigits1: Number(DecimalDigits1), DecimalDigits2: Number(DecimalDigits2) })},
    ...
    {"name": "ControlLetter", "symbols": [/[a-zA-Z]/], "postprocess": id},
    ...
    {"name": "LeadSurrogate", "symbols": ["Hex4Digits"], "postprocess": LeadSurrogate_CharacterValue},
    {"name": "TrailSurrogate", "symbols": ["Hex4Digits"], "postprocess": TrailSurrogate_CharacterValue},
    {"name": "NonSurrogate", "symbols": ["Hex4Digits"], "postprocess": NonSurrogate_CharacterValue},
